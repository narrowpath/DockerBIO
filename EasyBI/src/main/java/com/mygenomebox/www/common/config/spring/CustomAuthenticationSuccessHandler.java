...
public class CustomAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		logger.debug("Check User Info");
		User user = userService.getUserById(helixUser.getNouser());
		logger.debug("There is No user Insert User Db");
		if(user == null) {
			userService.txInsert(new User(helixUser));
		}
		
		userService.loginSuccess(helixUser.getNouser());
